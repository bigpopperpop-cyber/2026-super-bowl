...
export const NFL_TEAMS: NFLTeam[] = [
  ...
  { id: 'BUF', name: 'Bills', primary: '#00338D', secondary: '#C60C30' }
];
...
export const INITIAL_PROPS: PropBet[] = [
  ...
  { id: 'prop-3', question: "Gatorade Color over the winning coach?", category: 'Entertainment', resolved: false, options: ['Orange', 'Blue', 'Purple', 'Clear', 'Red'], points: 20 },
  { id: 'prop-4', question: "Coin Toss Result?", category: 'Pre-Game', resolved: false, options: ['Heads', 'Tails'], points: 5 },
  { id: 'prop-5', question: "Will there be a Scorigami?", category: 'Stats', resolved: false, options: ['Yes', 'No'], points: 50 },
  { id: 'prop-6', question: "Commercial with a Dog in it first?", category: 'Ads', resolved: false, options: ['Yes', 'No'], points: 15 }
];