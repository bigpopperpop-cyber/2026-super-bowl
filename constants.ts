...
// Added NFLTeam interface to support NFL_TEAMS constant
...
// Added NFL_TEAMS to resolve missing export error in TeamHelmet.tsx
...
export const INITIAL_PROPS: PropBet[] = [
  { id: 'start-1', category: 'PRE-GAME', question: 'Coin Toss Winner?', options: ['Home', 'Away'], resolved: false },
